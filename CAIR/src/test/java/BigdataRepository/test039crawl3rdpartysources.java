...
public class test039crawl3rdpartysources extends InnsightLogin {

	@AfterClass

	public void rdpartycrawl() throws InterruptedException, AWTException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id=\"ulEntifilSource\"]/li[21]/label/span")).click();
		Thread.sleep(2000);
